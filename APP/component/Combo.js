...
const Combo = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#00ab90' }}>TIN MỚI</Text>
      ...
      <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#00ab90' }}>TỔNG HỢP</Text>
      ...
      <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#00ab90' }}>NỔI BẬT</Text>
